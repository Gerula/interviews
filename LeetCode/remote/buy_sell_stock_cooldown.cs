...
//
//      Ok, I have no fucking clue how this shit works.
    public int MaxProfit(int[] prices) {
        var buy = int.MinValue;
        var noOp = int.MinValue;
        var coolDown = 0;
        var sell = 0;
